...
def getDepth(camera, cameraStats):
    frame = getFrame(camera)

    depth = o3d.geometry.PointCloud.create_from_depth_image(frame, cameraStats)
...
def setup(port):
    ...
    camera.setIntegrationTime3d(0, 700)       ## set integration time 0: 1000
